...
#define MESSAGE_TYPES_REQ(H) \
	H(initial_connect, config::server_config& server_config;)
...
#define CREATE_STRUCTURE_REQ(name, ...)                                            \
	...
	{                                                                              \
		message_##name##_request_t(const uid::uid_generator::uid_t uid) : uid(uid) \
		{}                                                                         \
                                                                                   \
...
#define CREATE_STRUCTURE_RES(name, ...)                                             \
	...
	{                                                                               \
		message_##name##_response_t(const uid::uid_generator::uid_t uid) : uid(uid) \
		{}                                                                          \
                                                                                    \

...
#define PLACE_HANDLERS_REQ(host, uid, name, ...) void host##_##name##_request_handler(flow::buffers::server_buffer_t& buffer, Poco::Net::WebSocket& ws);
#define PLACE_HANDLERS_RES(host, uid, name, ...) void host##_##name##_response_handler(flow::buffers::server_buffer_t& buffer);
